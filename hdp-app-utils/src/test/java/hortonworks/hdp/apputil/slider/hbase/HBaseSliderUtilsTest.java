...
public class HBaseSliderUtilsTest{
	...
	public static final String SLIDER_HBASE_PUBLISHER_URL = "http://centralregion08.cloud.hortonworks.com:50472/ws/v1/slider/publisher";
	...
	public void getHBaseZookeeperParentNode() throws Exception {
		assertThat(sliderService.getHBaseZookeeperParentNode(), is("/services/slider/users/yarn/hbase-on-yarn-v30"));
	}
