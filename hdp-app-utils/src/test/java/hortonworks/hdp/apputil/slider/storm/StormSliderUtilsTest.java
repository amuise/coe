...
public class StormSliderUtilsTest {
	...
	public static final String SLIDER_STORM_PUBLISHER_URL = "http://centralregion09.cloud.hortonworks.com:46638/ws/v1/slider/publisher";
	...
	public void getStormNimbusPort() throws Exception{
		assertThat(sliderService.getStormNimbusPort(), is("52110"));
	}	
	...
	public void getStormUIServerHost() throws Exception {
		assertThat(sliderService.getStormUIServer(), is("centralregion10.cloud.hortonworks.com"));
	}
	
	@Test
	public void getStormUIPort() throws Exception {
		assertThat(sliderService.getStormUIPort(), is("42361"));
	}	
